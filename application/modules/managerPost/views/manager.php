            ...
            <?php foreach ($result as $key => $value) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="window.open('<?= site_url('managerPost/index/index?action=delete&id=' . $value->id); ?>', '_parent')" class="btn btn-default text-danger"><i class="far fa-trash-alt"></i></button>
